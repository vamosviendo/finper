...
class TestEliminaCuenta(FunctionalTest):
    ...
    def test_puede_eliminar_movimientos(self):
        ...
        Movimiento.crear(concepto='saldo', importe=100, cta_entrada=cta1)
        Movimiento.crear(concepto='saldo', importe=200, cta_entrada=cta2)
        Movimiento.crear(
        ...
        # entrada
        saldo_cta1 = self.esperar_elemento('id_saldo_cta_e')
