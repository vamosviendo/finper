# Generated by Django 4.2.1 on 2024-01-07 21:36
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.CharField(max_length=20, unique=True, validators=[django.core.validators.RegexValidator('^[0-9a-z_\\-]*$', 'Solamente caracteres alfanuméricos y guiones')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('orden_dia', django_ordered_field.ordered_collection_field.OrderedCollectionField(collection=('dia',), default=-1, extra_field_updates={}, self_updates_on_collection_change={}, update_auto_now=True)),
                ...
                ('dia', models.ForeignKey(default=diario.models.dia.Dia.ultima_id, on_delete=django.db.models.deletion.CASCADE, to='diario.dia')),
                ('moneda', models.ForeignKey(default=diario.utils.utils_moneda.id_moneda_base, on_delete=django.db.models.deletion.CASCADE, related_name='movimientos', to='diario.moneda')),
            ],
            options={
