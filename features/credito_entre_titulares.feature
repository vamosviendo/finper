...
Escenario: Traspaso de saldo entre cuentas de distintos titulares
    ...
    Entonces veo una cuenta en la grilla con slug "crtitojuan" y nombre "Préstamo de tito a juan"
    Y veo que el saldo de "Préstamo de tito a juan" es 30 pesos

    Cuando voy a la página "tit_detalle" del titular "Juan Juánez"

    Entonces veo una cuenta en la grilla con slug "dbjuantito" y nombre "Deuda de juan con tito"
    ...
    Entonces veo movimientos con los siguientes valores:
        ...
        | Constitución de crédito | de Tito Gómez a Juan Juánez | 10,00   | crtitojuan  | dbjuantito |
    ...
    Entonces veo movimientos con los siguientes valores:
        ...
        | Cancelación de crédito  | de Juan Juánez a Tito Gómez | 15,00   | crtitojuan  | dbjuantito |
    ...
    Entonces no veo una cuenta "crtitojuan" en la grilla
