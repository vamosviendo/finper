...
Escenario: Eliminar titular con cuentas sin saldo
    ...
    Y no veo un titular con nombre "Tito Gómez" en la grilla
    Y no veo una cuenta con nombre "cuenta 1" en la grilla
    Y no veo una cuenta con nombre "cuenta 2" en la grilla
...
Escenario: Eliminar titular con cuentas con saldo
    ...
    Entonces no veo un titular con nombre "Tito Gómez" en la grilla
    Y no veo una cuenta con nombre "cuenta 1" en la grilla
    Y no veo una cuenta con nombre "cuenta 2" en la grilla
