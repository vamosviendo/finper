...
def test_integrativo_genera_cuenta_credito_y_subcuentas_y_movimiento(cuenta, cuenta_ajena):
    ...
    cuenta_acreedora = Cuenta.tomar(sk=f'_{cuenta_ajena.titular.sk}-{cuenta.titular.sk}')
    cuenta_deudora = Cuenta.tomar(sk=f'_{cuenta.titular.sk}-{cuenta_ajena.titular.sk}')
    ...
    assert mov_credito.detalle == 'Constitución de crédito'
...
def test_cuentas_credito_se_tienen_una_a_la_otra_como_contracuenta(cuenta, cuenta_ajena):
    ...
    cuenta_acreedora = CuentaInteractiva.tomar(sk=f'_{cuenta_ajena.titular.sk}-{cuenta.titular.sk}')
    cuenta_deudora = CuentaInteractiva.tomar(sk=f'_{cuenta.titular.sk}-{cuenta_ajena.titular.sk}')
