...
urlpatterns = [
    ...
    path("ctas_inactivas/", views.CuentasInactivasView.as_view(), name='ctas_inactivas'),
    ...
    path('cta_desact/<slug:sk>', views.CtaDesactView.as_view(), name='cta_desact'),
    ...
    path('mov_elim/<slug:sk>', views.MovElimView.as_view(), name='mov_elim'),
    path('mov_mod/<slug:sk>', views.MovModView.as_view(), name='mov_mod'),
