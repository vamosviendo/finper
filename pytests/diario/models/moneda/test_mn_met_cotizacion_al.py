...
def test_devuelve_valor_de_cotizacion_vigente_a_la_fecha_dada(sentido, compra, cotizacion, cotizacion_posterior, dolar, fecha):
...
def test_cotizacion_compra_venta_devuelve_valor_de_cotizacion_vigente_a_la_fecha_dada(sentido, cotizacion, cotizacion_posterior, dolar, fecha):
